"""Symmetric NRTL Vacancy Solution Theory isotherm model."""
...
class SNRTLVST(ModelIsotherm, model_name='sNRTL-VST'):
    ...
    def pressure(self, loading):
        ...
        support fitting the VST isotherm with the Symmetric NRTL activity coefficient
        model. The Symmetric NRTL VST isotherm has three parameters, two from the
    ...
    def initial_guess(self):
        ...
        For the Symmetric NRTL Vacancy Solution Theory isotherm, we assume the case of
